<template>
    ...
    <img src="../icons/info.jpg" class="infoo" alt="Informacja o dopinansowaniu projektu ze środków Ministerstwa Kultury i 
 ...
 W związku z realizacją wniosku z Kultury Cyfrowej 2023 wykonano: <br>
 ...
 <br>
 <NuxtLink to="https://brygida-arch.vercel.app">
 https://brygida-arch.vercel.app </NuxtLink>
 <br>
 ...
 <br>
 <NuxtLink to="https://brygida-model.vercel.app/">
 https://brygida-model.vercel.app/ </NuxtLink>
 <br>
 3. Dodatkowo całość uwzględniające wszystkie zrealizowane dotychczas projekty znajduje się pod adresem:
 <br>
 <NuxtLink to="https://brygida-start.vercel.app/ ">
